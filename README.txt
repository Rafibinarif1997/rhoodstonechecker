...
DESIGN UPDATE — FULL STONE TEXT
The complete site now uses a carved/embossed stone typography treatment on all visible text, not only the main title. Text remains bright for readability, while layered stone highlights, dark bevels, shadows and texture overlays create a physical carved-stone appearance.
