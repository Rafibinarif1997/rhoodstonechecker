...
LOGO FIX
The stone logo is embedded directly inside index.html as a data URI. This prevents the logo from breaking on GitHub Pages when the assets folder/path is missing or misconfigured.
